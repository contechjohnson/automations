...
## Using Pre-Calculated Scores

The `lead_score`, `timing_urgency`, and `score_explanation` are provided as inputs. Use them directly:
- Display lead_score in the intro callout
- Use timing_urgency in the why_now section
- Include score_explanation in the intro callout content

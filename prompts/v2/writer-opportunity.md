You are a dossier section writer. Write the OPPORTUNITY INTELLIGENCE section.
...
- **project_type**: Category (data_center, mining_facility, cold_storage, manufacturing, warehouse, etc.)

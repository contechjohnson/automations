...
**Sections Produced:** TITLE, ONE_LINER, ANGLE, SCORE, SCORE DESCRIPTION, URGENCY
...
---
PROMPT: section-writer.intro.v1
MODEL: gpt-4.1
PURPOSE: Write the INTRO section (title, one_liner, angle, score, score_description, urgency)
---
...
TITLE, ONE_LINER, ANGLE, SCORE, SCORE DESCRIPTION, URGENCY

...
**Sections Produced:** DEAL_STRATEGY, COMMON_OBJECTIONS, COMPETITIVE_POSITIONING
...
---
PROMPT: section-writer.strategy.v1
MODEL: gpt-4.1
PURPOSE: Write STRATEGY (deal_strategy, common_objections, competitive_positioning)
---

You are a dossier section writer. Write the STRATEGY section from routed claims.
...
DEAL_STRATEGY, COMMON_OBJECTIONS, COMPETITIVE_POSITIONING

...
**industry_research**
Full (thorough) industry research configuration from Onboarding step
...
- `industry_research_compressed` - Compressed industry research (40-60% smaller)
...
**Purpose:** Token cost optimization for persona-based positioning and signal interpretation.

**Next Steps:**
- Compressed version used in entity research, signal discovery, contact discovery
- Original thorough version used in batch composer (high-impact planning)
- Saves 1,500-2,500 tokens per pipeline run

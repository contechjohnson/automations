...
**merged_claims_json**
Consolidated claims from entity research and contact discovery
...
- `research_narrative` - Enriched company profile (gets extracted to claims)

---

## Integration Notes

**Model:** o4-mini-deep-research (async, requires polling)
**Next Steps:** Claims extraction → MergedClaims update

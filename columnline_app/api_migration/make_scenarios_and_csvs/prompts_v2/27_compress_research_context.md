...
**research_context**
Full (thorough) research context from Onboarding step
...
- `research_context_compressed` - Compressed research context (40-60% smaller)
...
**Purpose:** Token cost optimization for positioning and credibility statements.

**Next Steps:**
- Compressed version used in entity research, opportunity research, positioning
- Original thorough version used in batch composer (high-impact planning)
- Saves 1,500-2,000 tokens per pipeline run
